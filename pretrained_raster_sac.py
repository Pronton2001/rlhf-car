...
ray.init(num_cpus=2, ignore_reinit_error=True, log_to_driver=False, object_store_memory = 5e9, local_mode = True)
...
from ray.rllib.models import ModelCatalog
from src.customModel.customModel import TorchRasterQNet, TorchRasterNetSAC
ModelCatalog.register_custom_model("RaterQNetSAC", TorchRasterQNet)
ModelCatalog.register_custom_model("RaterSAC", TorchRasterNetSAC)
ModelCatalog.register_custom_model("RaterPolicyNetSAC", TorchRasterQNet)
#################### Train ####################
...
ray_result_logdir = '/workspace/datasets/ray_results/debugSACRaster' + date
...
config_param_space = {
    ...
    # 'model':
    # {
    #     'custom_model': 'RaterSAC',
    # },
    'q_model':
        {

            'custom_model':'RaterQNetSAC',
        },
    'policy_model':
        {
            'custom_model':'RaterPolicyNetSAC',
        },
    # 'q_model_config' : {
    #         # "dim": 112,
