...
from src.customEnv.wrapper import L5EnvWrapper, L5EnvWrapperHFreward, L5EnvWrapperTorch
...
dataset_path = '/mnt/fablab/datasets/'
...
def rllib_model():
    ...
    checkpoint_path = '/media/pronton/linux_files/a100code/l5kit/l5kit_dataset/' + 'ray_results/31-12-2022_07-53-04/SAC/SAC_L5-CLE-V1_7bae1_00000_0_2022-12-31_00-53-04/checkpoint_000360'
    ...
    while True:
        ...
        if i % jump == 0:
            ...
            if type(env)== L5EnvWrapper:
                ...
                # plt.imshow(im[2])
                # plt.show()
            elif type(env) == L5EnvWrapperTorch:
...
PREFLOGDIR = 'src/pref/preferences/rasternet/'
directory = 'src/pref/preferences/rasternet/'
